  ...
  const projects = [
    {
      ...
      description: 'A Python-based tool supporting text translation, speech-to-text, text-to-speech, and summarization across 107 languages using Flask and Google Cloud APIs.',
    ...
    },
    {
      ...
      description: 'Node.js application for scraping headlines from Hacker News, outputting JSON data, with scheduled cron jobs for updates.',
    ...
    },
    {
      ...
      description: 'ML model using Jupyter Notebook to predict student grades, improving accuracy by 15% through feature engineering.',
    ...
    },
    {
      ...
      description: 'Full-stack platform with React frontend and Node.js backend for secure payments, supporting up to 500+ users.',
